...
if (i==0){
while (sonar.ping_cm()>=50 || sonar.ping() == 0) {  // Estoy especificando que cuando sea mayor que 50 cm la distancia. Especificar posteriormente la que queremos. El || (o) es por si esta muy lejos 
  //sensor.getRotation(&gx, &gy, &gz); //lee la velocidad angular, no hace Falta
//Turn On the engines
...
//Esta puesta para que deje pasar 5 segundos
   for (t=0; t<=5000;) {
